<?php
namespace StasDovgodko\Propel\Sync;
...
class Command extends MigrationMigrateCommand
{
    /**
     * Constructor.
     *
    ...
    {
        parent::__construct('migration:sync');
    ...
    protected function getGeneratorConfig(array $properties = null, InputInterface $input = null)
    {
        ...
        return parent::getGeneratorConfig($properties, $input);
    }
